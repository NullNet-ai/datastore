...
import {
  IActors,
  IGuards,
  ISearchSuggestionsContext,
  ISearchSuggestionsEvent,
} from '../schemas/search_suggestions/search_suggestions.schema';
/**
 * Represents the configuration for the search_suggestions machine.
 *
...
export const config = (
  ...
  context: ISearchSuggestionsContext = {
    controller_args: [],
    start_time: 0,
    end_time: 0,
    duration: 0,
  ...
  setup({
    types: {
      context: {} as ISearchSuggestionsContext,
      events: {} as ISearchSuggestionsEvent,
    },
