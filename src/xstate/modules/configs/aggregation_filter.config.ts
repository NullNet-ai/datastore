...
import {
  IActors,
  IGuards,
  IAggregationFilterContext,
  IAggregationFilterEvent,
...
export const config = (
  ...
  setup({
    types: {
      context: {} as IAggregationFilterContext,
      events: {} as IAggregationFilterEvent,
    },
    ...
    states: {
      ...
      processingRequest: {
        ...
        states: {
          ...
          aggregationFilter: {
            invoke: {
              id: 'aggregationFilter',
              src: 'aggregationFilter',
              input: ({ context }) => ({ context }),
              onDone: {
                target: 'success',
              },
