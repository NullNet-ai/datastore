...
import { IActors } from '../../schemas/template/template.schema';

@Injectable()
export class TemplateActorsImplementations {
  /**
   * Implementation of actors for the template machine.
   */
  public readonly actors: IActors = {
     ...
     */
    sampleStep: fromPromise(async ({ input }): Promise<IResponse> => {
      const { context } = input;
