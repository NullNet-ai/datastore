...
@Injectable()
export class PgFunctionMachine
  extends MachineInit
  implements IMachineProperties, OnModuleInit
{
  ...
  constructor(
    ...
    private ai: PgFunctionActionsImplementations,
    private si: PgFunctionActorsImplementations,
    private gi: PgFunctionGuardsImplementations,
    ...
    // this.delays = {};
    // Define the correct path to the machine pg_function config
