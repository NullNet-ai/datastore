...
@Injectable()
export class AggregationFilterMachine
  extends MachineInit
  implements IMachineProperties, OnModuleInit
{
  ...
  constructor(
    ...
    private ai: AggregationFilterActionsImplementations,
    private si: AggregationFilterActorsImplementations,
    private gi: AggregationFilterGuardsImplementations,
    ...
    // this.delays = {};
    // Define the correct path to the machine aggregation_filter config
