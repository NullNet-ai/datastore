  ...
  implements IMachineProperties, OnModuleInit
{
  ...
  constructor(
    ...
    logger: Logger,
    private ai: UploadsActionsImplementations,
    private si: UploadsActorsImplementations,
    private gi: UploadsGuardsImplementations,
    ...
    // this.delays = {};
    // Define the correct path to the machine uploads config
