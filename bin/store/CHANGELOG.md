...
### Fixes
  - fix(store): prevent duplicate routes and preserve existing organization_id
    - Remove duplicate trailing slash routes to avoid conflicts
    - Only set organization_id if not already present in record
