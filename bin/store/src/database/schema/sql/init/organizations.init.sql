...
DECLARE
    ...
    fields field_type[] := ARRAY[
        ...
        -- main fields
        ROW('ParentOrganizationId_parent_organization_id_text', 'ParentOrganizationId', 'parent_organization_id', 'text', record_email, false, false, false,'','',to_jsonb(ARRAY['']))::field_type,
        ROW('Name_name_text', 'Name', 'name', 'text', record_email, false, false, false,'','',to_jsonb(ARRAY['']))::field_type,
        ROW('OrganizationLevel_organization_level_integer', 'OrganizationLevel', 'organization_level', 'integer', record_email, false, false, false,'','',to_jsonb(ARRAY['']))::field_type,
        ROW('RootOrganizationId_root_organization_id_text', 'RootOrganizationId', 'root_organization_id', 'text', record_email, false, false, false,'','',to_jsonb(ARRAY['']))::field_type,
        ROW('PathLevel_path_level_jsonb', 'PathLevel', 'path_level', 'jsonb', record_email, false, false, false,'','',to_jsonb(ARRAY['']))::field_type
