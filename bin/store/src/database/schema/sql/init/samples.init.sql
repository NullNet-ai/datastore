...
DECLARE
    ...
    fields field_type[] := ARRAY[
        ...
        ROW('SampleText_sample_text_text', 'SampleText', 'sample_text', 'text', record_email, false, false, false,'','',to_jsonb(ARRAY['']))::field_type,
        ROW('TestObj_test_obj_jsonb', 'TestObj', 'test_obj', 'jsonb', record_email, false, false, false,'[]','',to_jsonb(ARRAY['']))::field_type
    ];
