 ...
 */
pub struct TempDeviceRemoteAccessSessionsTable;
...
define_table_schema! {
    ...
    indexes: {
        ...
        system_indexes!("temp_device_remote_access_sessions"),
    },
    foreign_keys: {
        // System field foreign keys ( REQUIRED )
        system_foreign_keys!("temp_device_remote_access_sessions"),
        fk_temp_device_remote_access_sessions_device_id: { columns: ["device_id"], foreign_table: "devices", foreign_columns: ["id"], on_delete: "no action", on_update: "no action" },
    }
}
