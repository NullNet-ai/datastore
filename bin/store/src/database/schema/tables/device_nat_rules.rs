 ...
 */
pub struct DeviceNatRulesTable;
...
define_table_schema! {
    ...
    indexes: {
        ...
        system_indexes!("device_nat_rules"),
    },
    foreign_keys: {
        // System field foreign keys ( REQUIRED )
        system_foreign_keys!("device_nat_rules"),
        fk_device_nat_rules_device_configuration_id: { columns: ["device_configuration_id"], foreign_table: "device_configurations", foreign_columns: ["id"], on_delete: "no action", on_update: "no action" },
    }
}
