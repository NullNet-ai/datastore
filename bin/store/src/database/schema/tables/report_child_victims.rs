...
define_table_schema! {
    ...
    indexes: {
        ...
        idx_report_child_victims_report_id: {
            columns: ["report_id"],
            unique: false,
            type: "btree"
        },
        idx_report_child_victims_first_name: {
            columns: ["first_name"],
            unique: false,
            type: "btree"
        },
        idx_report_child_victims_last_name: {
            columns: ["last_name"],
            unique: false,
            type: "btree"
        },
        idx_report_child_victims_birth_date: {
            columns: ["birth_date"],
            unique: false,
            type: "btree"
        },
        idx_report_child_victims_email: {
            columns: ["email"],
            unique: false,
            type: "btree"
        },
        idx_report_child_victims_address_street: {
            columns: ["address_street"],
            unique: false,
            type: "btree"
        },
        idx_report_child_victims_address_city: {
            columns: ["address_city"],
            unique: false,
            type: "btree"
        },
        idx_report_child_victims_address_zip_code: {
            columns: ["address_zip_code"],
            unique: false,
            type: "btree"
        },
        idx_report_child_victims_address_state: {
            columns: ["address_state"],
            unique: false,
            type: "btree"
        },
        idx_report_child_victims_address_non_usa_state: {
            columns: ["address_non_usa_state"],
            unique: false,
            type: "btree"
        },
        idx_report_child_victims_address_country: {
            columns: ["address_country"],
            unique: false,
            type: "btree"
        },
        idx_report_child_victims_phone_country_code: {
            columns: ["phone_country_code"],
            unique: false,
            type: "btree"
        },
        idx_report_child_victims_phone_extension: {
            columns: ["phone_extension"],
            unique: false,
            type: "btree"
        },
        idx_report_child_victims_screen_name: {
            columns: ["screen_name"],
            unique: false,
            type: "btree"
        },
