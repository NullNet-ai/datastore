...
define_table_schema! {
    ...
    indexes: {
        ...
        system_indexes!("packets"),
        // Custom table-specific indexes
        idx_packets_total_length: {
    ...
    foreign_keys: {
        ...
        system_foreign_keys!("packets"),
        fk_packets_device_id: { columns: ["device_id"], foreign_table: "devices", foreign_columns: ["id"], on_delete: "no action", on_update: "no action" },
    }
}
