...
define_table_schema! {
    ...
    indexes: {
        ...
        idx_teacher_schools_district_id: {
            columns: ["district_id"],
            unique: false,
            type: "btree"
        },
        idx_teacher_schools_department_id: {
    ...
    foreign_keys: {
        ...
        fk_teacher_schools_district_id: {
            columns: ["district_id"],
            foreign_table: "organizations",
            foreign_columns: ["id"],
            on_delete: "no action",
        ...
        fk_teacher_schools_department_id: {
            columns: ["department_id"],
            foreign_table: "organizations",
            foreign_columns: ["id"],
            on_delete: "no action",
