...
define_table_schema! {
    ...
    indexes: {
        ...
        idx_organization_contacts_contact_id: {
            columns: ["contact_id"],
            unique: false,
            type: "btree"
        },
        idx_organization_contacts_is_primary: {
            columns: ["is_primary"],
            unique: false,
            type: "btree"
        },
        idx_organization_contacts_contact_organization_id: {
            columns: ["contact_organization_id"],
            unique: false,
            type: "btree"
        },
    },
