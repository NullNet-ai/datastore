...
define_table_schema! {
    ...
    indexes: {
        ...
        system_indexes!("temp_packets"),
    },
    foreign_keys: {
        // System field foreign keys ( REQUIRED )
        system_foreign_keys!("temp_packets"),
        fk_temp_packets_device_id: { columns: ["device_id"], foreign_table: "devices", foreign_columns: ["id"], on_delete: "no action", on_update: "no action" },
    }
}
