 ...
 */
pub struct TempDeviceFilterRulesTable;
...
define_table_schema! {
    ...
    indexes: {
        ...
        system_indexes!("temp_device_filter_rules"),
    },
    foreign_keys: {
        // System field foreign keys ( REQUIRED )
        system_foreign_keys!("temp_device_filter_rules"),
        fk_temp_device_filter_rules_device_configuration_id: { columns: ["device_configuration_id"], foreign_table: "device_configurations", foreign_columns: ["id"], on_delete: "no action", on_update: "no action" },
    }
}
