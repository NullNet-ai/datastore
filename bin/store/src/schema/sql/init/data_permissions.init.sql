...
DECLARE
    ...
    fields field_type[] := ARRAY[
        ...
        ROW('EntityFieldId_entity_id_text', 'Entity Field Id', 'entity_field_id', 'text', record_email, false)::field_type,
        ROW('PermissionId_permission_id_text', 'Permission Id', 'permission_id', 'text', record_email, false)::field_type,
        ROW('InheritedPermissionId_permission_id_text', 'Inherited Permission Id', 'inherited_permission_id', 'text', record_email, false)::field_type,
        ROW('AccountOrganizationId_account_organization_id_text', 'Account Organization Id', 'account_organization_id', 'text',record_email, false)::field_type,
        ROW('Version_version_serial', 'Version', 'version', 'serial', record_email, false)::field_type,
        ROW('CreatedBy_created_by_text', 'Created By', 'created_by', 'text', record_email, false)::field_type,
        ROW('UpdatedBy_updated_by_text', 'Updated By', 'updated_by', 'text', record_email, false)::field_type,
        ROW('DeletedBy_deleted_by_text', 'Deleted By', 'deleted_by', 'text', record_email, false)::field_type,
