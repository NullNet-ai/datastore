...
mod tests {
    use super::*;
    use crate::structs::structs::{Aggregation, AggregationFilter, AggregationType, FilterCriteria, Join, AggregationOrder};
    use crate::providers::queries::aggregation_filter::sql_constructor::{AggregationQueryFilter, AggregationFilterWrapper, AggregationSQLConstructor};
    ...
    fn create_test_aggregation_filter_wrapper() -> AggregationFilterWrapper {
        let request = crate::generated::store::AggregationFilterRequest {
            ...
            body: Some(crate::generated::store::aggregation_filter_request::AggregationFilterBody {
                entity: "transactions".to_string(),
    ...
    fn test_aggregation_query_filter_defaults() {
        ...
        assert_eq!(AggregationQueryFilter::get_bucket_size(&filter), Some("1 hour"));
        ...
        assert_eq!(AggregationQueryFilter::get_entity(&filter), Some("transactions"));
    }
    ...
    fn test_construct_aggregation_missing_aggregations() {
        ...
        assert!(result.unwrap_err().contains("Missing required parameter: aggregations cannot be empty"));
    }
    ...
    fn test_construct_aggregation_missing_bucket_size() {
        ...
        let result = constructor.construct_aggregation();
        assert!(result.is_err());
        assert!(result.unwrap_err().contains("Missing required parameter: bucket_size"));
    }
    ...
    fn test_construct_aggregation_missing_entity() {
        ...
        println!("Error in test_construct_aggregation_missing_entity: {}", error_msg);
    ...
    fn test_aggregation_filter_wrapper_aggregation_query_filter() {
        ...
        assert_eq!(AggregationQueryFilter::get_bucket_size(&wrapper), Some("1 hour"));
        assert_eq!(AggregationQueryFilter::get_timezone(&wrapper), Some("UTC"));
        assert_eq!(AggregationQueryFilter::get_entity(&wrapper), Some("transactions"));
    }
