...
use crate::generated::store::{
    ...
    AggregationFilterResponse, AppFirewalls, AppguardLogs, BatchDeleteAccountOrganizationsRequest,
    ...
    BatchDeleteAppFirewallsResponse, BatchDeleteAppguardLogsRequest,
    BatchDeleteAppguardLogsResponse, BatchDeleteConnectionsRequest, BatchDeleteConnectionsResponse,
    ...
    BatchDeleteContactsRequest, BatchDeleteContactsResponse, BatchDeleteDeviceAliasesRequest,
    BatchDeleteDeviceAliasesResponse, BatchDeleteDeviceConfigurationsRequest,
    BatchDeleteDeviceConfigurationsResponse, BatchDeleteDeviceGroupSettingsRequest,
    BatchDeleteDeviceGroupSettingsResponse, BatchDeleteDeviceInterfaceAddressesRequest,
    BatchDeleteDeviceInterfaceAddressesResponse, BatchDeleteDeviceInterfacesRequest,
    BatchDeleteDeviceInterfacesResponse, BatchDeleteDeviceRemoteAccessSessionsRequest,
    BatchDeleteDeviceRemoteAccessSessionsResponse, BatchDeleteDeviceRulesRequest,
    BatchDeleteDeviceRulesResponse, BatchDeleteDeviceSshKeysRequest,
    ...
    BatchDeleteTempConnectionsResponse, BatchDeleteTempDeviceAliasesRequest,
    BatchDeleteTempDeviceAliasesResponse, BatchDeleteTempDeviceInterfaceAddressesRequest,
    ...
    BatchInsertTempConnectionsResponse, BatchInsertTempDeviceAliasesRequest,
    BatchInsertTempDeviceAliasesResponse, BatchInsertTempDeviceInterfaceAddressesRequest,
    ...
    BatchUpdateTempConnectionsResponse, BatchUpdateTempDeviceAliasesRequest,
    BatchUpdateTempDeviceAliasesResponse, BatchUpdateTempDeviceInterfaceAddressesRequest,
    ...
    CreateWallguardLogsRequest, CreateWallguardLogsResponse, DeleteAccountOrganizationsRequest,
    ...
    DeviceRules, DeviceSshKeys, Devices, ExternalContacts, GetAccountOrganizationsRequest,
    ...
    UpdateAppFirewallsRequest, UpdateAppFirewallsResponse, UpdateAppguardLogsRequest,
    UpdateAppguardLogsResponse, UpdateConnectionsRequest, UpdateConnectionsResponse,
