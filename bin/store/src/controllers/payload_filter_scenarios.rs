...
impl PayloadFilterScenarios {
    ...
    pub fn update_scenario(
        ...
        match self.scenarios.get_mut(name) {
            ...
            None => Err(PayloadFilterScenarioError::ScenarioNotFound(name.to_string())),
        }
    }
    ...
    pub fn get_scenario_mut(&mut self, name: &str) -> Result<&mut Scenario, PayloadFilterScenarioError> {
        self.scenarios
            .get_mut(name)
            .ok_or_else(|| PayloadFilterScenarioError::ScenarioNotFound(name.to_string()))
    }
    ...
    pub fn get_scenario_filter(&self, name: &str) -> Result<&GetByFilter, PayloadFilterScenarioError> {
    ...
    pub fn set_current_scenario(&mut self, name: &str) -> Result<(), PayloadFilterScenarioError> {
        if !self.scenarios.contains_key(name) {
            return Err(PayloadFilterScenarioError::ScenarioNotFound(name.to_string()));
        }
    ...
    pub fn clone_scenario(
        ...
        if self.scenarios.contains_key(&target_name) {
            return Err(PayloadFilterScenarioError::ScenarioAlreadyExists(target_name));
        }
    ...
    pub fn save_scenario_to_file(&self, scenario_name: &str) -> Result<(), PayloadFilterScenarioError> {
    ...
    pub fn load_scenario_from_file(&mut self, scenario_name: &str) -> Result<(), PayloadFilterScenarioError> {
...
mod tests {
    ...
    fn should_create_and_retrieve_scenario() {
        ...
        let mut payload_filters = PayloadFilterScenarios::new("test_table".to_string(), create_test_filter());
    ...
    fn should_handle_duplicate_scenario_creation() {
        ...
        payload_filters.create_scenario("duplicate".to_string(), scenario_filter.clone()).unwrap();
        let result = payload_filters.create_scenario("duplicate".to_string(), scenario_filter);
        
        assert!(result.is_err());
        assert!(matches!(result.unwrap_err(), PayloadFilterScenarioError::ScenarioAlreadyExists(_)));
    ...
    fn should_set_and_get_current_scenario() {
        ...
        payload_filters.create_scenario("current_test".to_string(), scenario_filter).unwrap();
        payload_filters.set_current_scenario("current_test").unwrap();
        
        assert_eq!(payload_filters.get_current_scenario(), Some(&"current_test".to_string()));
    ...
    fn should_delete_scenario() {
        ...
        payload_filters.create_scenario("to_delete".to_string(), scenario_filter).unwrap();
    ...
    fn should_clone_scenario() {
        ...
        payload_filters.create_scenario_with_description(
            "original".to_string(),
    ...
    fn should_save_and_load_scenario_from_file() {
        ...
        payload_filters.create_scenario("file_test".to_string(), scenario_filter.clone()).unwrap();
        ...
        let mut new_payload_filters = PayloadFilterScenarios::new("test_table".to_string(), create_test_filter());
    ...
    fn should_delete_scenario_and_file() {
        ...
        // Create scenario
        payload_filters.create_scenario("delete_test".to_string(), scenario_filter).unwrap();
    ...
    fn should_update_scenario_and_save_to_file() {
        ...
        // Create scenario
        payload_filters.create_scenario("update_test".to_string(), initial_filter).unwrap();
    ...
    fn should_load_all_scenarios_from_files() {
        ...
        payload_filters.create_scenario("bulk_test_1".to_string(), filter1).unwrap();
        payload_filters.create_scenario("bulk_test_2".to_string(), filter2).unwrap();
