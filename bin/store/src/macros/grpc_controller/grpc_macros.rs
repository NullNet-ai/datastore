        ...
        paste::paste! {
                ...
                Self: 'async_trait,
            {
                Box::pin(async move {
                    ...
                    let wrapper = crate::providers::queries::aggregation_filter::AggregationFilterWrapper::new(request);
                    let mut sql_constructor = crate::providers::queries::aggregation_filter::AggregationSQLConstructor::new(wrapper, table.clone(), is_root_request, None)
        ...
        paste::paste! {
                ...
                Self: 'async_trait,
            {
                Box::pin(async move {
                    ...
                    let sql_constructor = crate::providers::queries::batch_update::BatchUpdateSQLConstructor::new(
                        params.table.clone(),
                        params.r#type == "root"
                    ).with_organization_id(auth_data.organization_id.clone());
