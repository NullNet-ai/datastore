...
use crate::controllers::{
    health_controller::{
        ComponentMetadataRequest, ComponentStatisticsResponse, DetailedHealthResponse,
        HealthCheckRequest, HealthResponse, LivenessResponse, MonitoringConfigRequest,
        MonitoringStatusResponse, ReadinessResponse,
    },
    organization_controller::{AuthByTokenDto, AuthDto, RegisterDto},
    pg_functions::pg_listener_controller::{CreateFunctionRequest, TestFunctionRequest},
    store_controller::{
        BatchInsertBody, SchemaVerificationRequest, SchemaVerificationResponse, TriggerListQuery,
    },
    sync_endpoints_controller::EndpointRequest,
};
use crate::structs::{
    core::{
        AdvancedUpsertRequestBody, AggregationFilter, ApiResponse, BatchUpdateBody, GetByFilter,
        RequestBody, SearchSuggestionParams, SwitchAccountRequest, UpsertRequestBody,
    },
    organizations_structs::VerifyPasswordParams,
};
...
#[utoipa::path(
    ...
    request_body(content = EndpointRequest),
...
#[utoipa::path(post, path = "/api/organizations/register", tag = "Organizations", summary = "Register organization", request_body(content = RegisterDto), responses((status = 200, description = "Registered", body = serde_json::Value)))]
fn org_register_doc() {}

#[utoipa::path(put, path = "/api/organizations/register/{id}", tag = "Organizations", summary = "Re-register existing account", params(("id" = String, Path, description = "Account identifier")), request_body(content = RegisterDto), responses((status = 200, description = "Re-registered", body = serde_json::Value)))]
fn org_reregister_existing_account_doc() {}

#[utoipa::path(post, path = "/api/organizations/auth", tag = "Organizations", summary = "Authenticate organization user", request_body(content = AuthDto), responses((status = 200, description = "Authenticated", body = serde_json::Value), (status = 401, description = "Unauthorized", body = StandardErrorResponse)))]
fn org_auth_doc() {}

#[utoipa::path(post, path = "/api/organizations/auth/sso", tag = "Organizations", summary = "Authenticate with SSO", request_body(content = AuthDto), responses((status = 200, description = "Authenticated with SSO", body = serde_json::Value)))]
fn org_auth_sso_doc() {}

#[utoipa::path(post, path = "/api/organizations/auth/token", tag = "Organizations", summary = "Authenticate by token", request_body(content = AuthByTokenDto), responses((status = 200, description = "Token authenticated", body = serde_json::Value)))]
...
#[utoipa::path(post, path = "/api/token/verify", tag = "Token", summary = "Verify token", params(("t" = Option<String>, Query, description = "Token value"), ("authorization" = Option<String>, Header, description = "Bearer token")), responses((status = 200, description = "Token validity checked", body = ApiResponse)))]
fn token_verify_doc() {}

#[utoipa::path(post, path = "/api/token/api/password/verify", tag = "Token", summary = "Verify password", request_body(content = VerifyPasswordParams), responses((status = 200, description = "Password checked", body = ApiResponse)))]
...
#[utoipa::path(post, path = "/api/store/root/aggregate", tag = "Root Store", security(("bearer_auth" = [])), summary = "Run root aggregate filter", request_body(content = AggregationFilter), responses((status = 200, description = "Aggregation result", body = ApiResponse)))]
fn root_aggregation_filter_doc() {}

#[utoipa::path(post, path = "/api/store/root/switch_account", tag = "Root Store", security(("bearer_auth" = [])), summary = "Switch account context", request_body(content = SwitchAccountRequest), responses((status = 200, description = "Account switched", body = ApiResponse)))]
fn root_switch_account_doc() {}

#[utoipa::path(post, path = "/api/store/root/verify_schema", tag = "Root Store", security(("bearer_auth" = [])), summary = "Verify schema integrity", request_body(content = SchemaVerificationRequest), responses((status = 200, description = "Schema verification output", body = SchemaVerificationResponse)))]
...
#[utoipa::path(post, path = "/api/store/root/upsert/{table}", tag = "Root Store", security(("bearer_auth" = [])), summary = "Upsert root-scoped record", params(("table" = String, Path, description = "Table name")), request_body(content = UpsertRequestBody), responses((status = 200, description = "Record upserted", body = ApiResponse)))]
fn root_upsert_doc() {}

#[utoipa::path(post, path = "/api/store/root/advance_upsert/{table}", tag = "Root Store", security(("bearer_auth" = [])), summary = "Advanced upsert root-scoped record", params(("table" = String, Path, description = "Table name")), request_body(content = AdvancedUpsertRequestBody, example = json!({"data":{"name":"inserted three","status":"Active"},"conflict_columns":["name"],"action":"update_fields","update_fields":["status"]})), responses((status = 200, description = "Record upserted", body = ApiResponse)))]
fn root_advanced_upsert_doc() {}

#[utoipa::path(patch, path = "/api/store/root/batch/{table}", tag = "Root Store", security(("bearer_auth" = [])), summary = "Batch update root-scoped records", params(("table" = String, Path, description = "Table name")), request_body(content = BatchUpdateBody), responses((status = 200, description = "Batch updated", body = ApiResponse)))]
...
#[utoipa::path(post, path = "/api/store/root/{table}/filter", tag = "Root Store", security(("bearer_auth" = [])), summary = "Filter root-scoped records", params(("table" = String, Path, description = "Table name")), request_body(content = GetByFilter), responses((status = 200, description = "Filtered records", body = ApiResponse)))]
fn root_get_by_filter_doc() {}

#[utoipa::path(post, path = "/api/store/root/{table}/count", tag = "Root Store", security(("bearer_auth" = [])), summary = "Count root-scoped records", params(("table" = String, Path, description = "Table name")), request_body(content = GetByFilter), responses((status = 200, description = "Count result", body = ApiResponse)))]
...
#[utoipa::path(post, path = "/api/store/root/batch/{table}", tag = "Root Store", security(("bearer_auth" = [])), summary = "Batch insert root-scoped records", params(("table" = String, Path, description = "Table name")), request_body(content = BatchInsertBody), responses((status = 200, description = "Batch inserted", body = ApiResponse)))]
fn root_batch_insert_records_doc() {}

#[utoipa::path(post, path = "/api/store/root/{table}/filter/suggestions", tag = "Root Store", security(("bearer_auth" = [])), summary = "Get root-scoped filter suggestions", params(("table" = String, Path, description = "Table name")), request_body(content = SearchSuggestionParams), responses((status = 200, description = "Suggestions list", body = ApiResponse)))]
...
#[utoipa::path(post, path = "/api/store/aggregate", tag = "Store", security(("bearer_auth" = [])), summary = "Run store aggregate filter", request_body(content = AggregationFilter), responses((status = 200, description = "Aggregation result", body = ApiResponse)))]
fn store_aggregation_filter_doc() {}

#[utoipa::path(post, path = "/api/store/verify_schema", tag = "Store", security(("bearer_auth" = [])), summary = "Verify store schema", request_body(content = SchemaVerificationRequest), responses((status = 200, description = "Schema verification output", body = SchemaVerificationResponse)))]
...
#[utoipa::path(post, path = "/api/store/upsert/{table}", tag = "Store", security(("bearer_auth" = [])), summary = "Upsert record", params(("table" = String, Path, description = "Table name")), request_body(content = UpsertRequestBody), responses((status = 200, description = "Record upserted", body = ApiResponse)))]
fn store_upsert_doc() {}

#[utoipa::path(patch, path = "/api/store/batch/{table}", tag = "Store", security(("bearer_auth" = [])), summary = "Batch update records", params(("table" = String, Path, description = "Table name")), request_body(content = BatchUpdateBody), responses((status = 200, description = "Batch updated", body = ApiResponse)))]
...
#[utoipa::path(post, path = "/api/store/{table}/filter", tag = "Store", security(("bearer_auth" = [])), summary = "Filter records", params(("table" = String, Path, description = "Table name")), request_body(content = GetByFilter), responses((status = 200, description = "Filtered records", body = ApiResponse)))]
fn store_get_by_filter_doc() {}

#[utoipa::path(post, path = "/api/store/{table}/count", tag = "Store", security(("bearer_auth" = [])), summary = "Count records", params(("table" = String, Path, description = "Table name")), request_body(content = GetByFilter), responses((status = 200, description = "Count result", body = ApiResponse)))]
...
#[utoipa::path(post, path = "/api/store/batch/{table}", tag = "Store", security(("bearer_auth" = [])), summary = "Batch insert records", params(("table" = String, Path, description = "Table name")), request_body(content = BatchInsertBody), responses((status = 200, description = "Batch inserted", body = ApiResponse)))]
fn store_batch_insert_records_doc() {}

#[utoipa::path(post, path = "/api/store/switch_account", tag = "Store", security(("bearer_auth" = [])), summary = "Switch account context", request_body(content = SwitchAccountRequest), responses((status = 200, description = "Account switched", body = ApiResponse)))]
fn store_switch_account_doc() {}

#[utoipa::path(post, path = "/api/store/{table}/filter/suggestions", tag = "Store", security(("bearer_auth" = [])), summary = "Get filter suggestions", params(("table" = String, Path, description = "Table name")), request_body(content = SearchSuggestionParams), responses((status = 200, description = "Suggestions list", body = ApiResponse)))]
fn store_search_suggestions_doc() {}


#[utoipa::path(get, path = "/api/listener", tag = "Listener", security(("bearer_auth" = [])), summary = "Get listener configuration", responses((status = 200, description = "Listener config", body = ApiResponse)))]
fn listener_get_doc() {}

#[utoipa::path(post, path = "/api/listener/function", tag = "Listener", security(("bearer_auth" = [])), summary = "Create listener function", request_body(content = CreateFunctionRequest), responses((status = 200, description = "Function created", body = ApiResponse)))]
fn listener_create_function_doc() {}

#[utoipa::path(post, path = "/api/listener/test", tag = "Listener", security(("bearer_auth" = [])), summary = "Test listener function syntax", request_body(content = TestFunctionRequest), responses((status = 200, description = "Syntax result", body = ApiResponse)))]
...
#[utoipa::path(get, path = "/api/health", tag = "Health", summary = "Basic health check", responses((status = 200, description = "Service health", body = HealthResponse)))]
fn health_check_doc() {}
...
#[utoipa::path(get, path = "/api/health/detailed", tag = "Health", summary = "Detailed health check", responses((status = 200, description = "Detailed health info", body = DetailedHealthResponse)))]
fn health_detailed_doc() {}

#[utoipa::path(get, path = "/api/health/ready", tag = "Health", summary = "Readiness probe", responses((status = 200, description = "Readiness state", body = ReadinessResponse)))]
fn health_ready_doc() {}

#[utoipa::path(get, path = "/api/health/live", tag = "Health", summary = "Liveness probe", responses((status = 200, description = "Liveness state", body = LivenessResponse)))]
fn health_live_doc() {}
...
#[utoipa::path(get, path = "/api/health/components/statistics", tag = "Health", summary = "Get component statistics", responses((status = 200, description = "Component statistics", body = ComponentStatisticsResponse)))]
fn health_component_statistics_doc() {}

#[utoipa::path(put, path = "/api/health/components/{component_name}/metadata", tag = "Health", summary = "Update component metadata", params(("component_name" = String, Path, description = "Component name")), request_body(content = ComponentMetadataRequest), responses((status = 200, description = "Metadata updated", body = serde_json::Value)))]
fn health_update_component_metadata_doc() {}

#[utoipa::path(post, path = "/api/health/components/{component_name}/health-check", tag = "Health", summary = "Record component health check", params(("component_name" = String, Path, description = "Component name")), request_body(content = HealthCheckRequest), responses((status = 200, description = "Health check recorded", body = serde_json::Value)))]
...
#[utoipa::path(get, path = "/api/health/monitoring/status", tag = "Health", summary = "Get monitoring status", responses((status = 200, description = "Monitoring status", body = MonitoringStatusResponse)))]
fn health_monitoring_status_doc() {}

#[utoipa::path(put, path = "/api/health/monitoring/interval", tag = "Health", summary = "Set monitoring interval", request_body(content = MonitoringConfigRequest), responses((status = 200, description = "Monitoring interval updated", body = serde_json::Value)))]
