...
use crate::generated::models::smtp_header_model::SmtpHeaderModel;
use crate::generated::models::school_admin_model::SchoolAdminModel;
use crate::generated::models::district_admin_model::DistrictAdminModel;
...
impl Table {
    pub fn from_str(name: &str) -> Option<Self> {
        match name {
            ...
            "smtp_headers" => Some(Table::SmtpHeaders),
            "school_admins" => Some(Table::SchoolAdmins),
            "district_admins" => Some(Table::DistrictAdmins),
            // Add other tables here
            _ => None,
        }
    }
