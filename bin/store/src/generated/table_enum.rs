...
use crate::generated::models::checkpoint_sample_model::CheckpointSampleModel;
...
impl Table {
    pub fn from_str(name: &str) -> Option<Self> {
        match name {
            ...
            "checkpoint_samples" => Some(Table::CheckpointSamples),
