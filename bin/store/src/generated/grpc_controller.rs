...
impl StoreService for GrpcController {
    ...
    // CRUD methods for test_samples
    generate_create_method!(test_samples);
    generate_update_method!(test_samples, test_sample);
    generate_batch_insert_method!(test_samples);
    generate_batch_update_method!(test_samples);
    generate_get_method!(test_samples);
    generate_delete_method!(test_samples);
    generate_batch_delete_method!(test_samples);
    generate_upsert_method!(test_samples);
