...
impl StoreService for GrpcController {
    ...
    // CRUD methods for demo_items
    generate_create_method!(demo_items);
    generate_update_method!(demo_items, demo_item);
    generate_batch_insert_method!(demo_items);
    generate_batch_update_method!(demo_items);
    generate_get_method!(demo_items);
    generate_delete_method!(demo_items);
    generate_batch_delete_method!(demo_items);
    generate_upsert_method!(demo_items);
    // CRUD methods for test_products
    generate_create_method!(test_products);
    generate_update_method!(test_products, test_product);
    generate_batch_insert_method!(test_products);
    generate_batch_update_method!(test_products);
    generate_get_method!(test_products);
    generate_delete_method!(test_products);
    generate_batch_delete_method!(test_products);
    generate_upsert_method!(test_products);
