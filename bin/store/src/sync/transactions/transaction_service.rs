...
impl TransactionService {
    ...
    pub fn expire_transaction(conn: &mut DbPooledConnection, transaction_id: &str) -> Result<(), DieselError> {
    ...
    pub fn start_transaction(conn: &mut DbPooledConnection, existing_id: Option<String>) -> Result<String, Box<dyn std::error::Error>> {
    ...
    pub fn stop_transaction(conn: &mut DbPooledConnection, transaction_id: &str) -> Result<(), DieselError> {
