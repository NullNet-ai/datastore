...
pub mod database {
    pub use super::{
        BUILD_SCRIPT, GRPC_CONTROLLER_FILE, GENERATED_DIR, HYPERTABLES_FILE, MIGRATIONS_DIR,
...
pub mod proto {
    pub use super::{BUILD_SCRIPT, GENERATED_DIR, PROTO_OUTPUT_DIR as OUTPUT_DIR, PROTO_SOURCE_FILE as SOURCE_FILE};
}
